            ...
            "properties": {
                "sql_query": {
                    ...
                    "description": (
                        ...
                        "the status 'paid' means the payment is completed (a.k.a paid)."
                        "On the other hand, the status 'pending' or 'overdue' means the payment is not completed yet (a.k.a not paid). "
                        "please be careful about compose query for status, because often the where clause might require multiple status"
